...
public class Decipher {
    ...
    public static void main(String[] args) {
        System.out.println(new Decipher().deCipher("PBPQTAHSPTCDCWXTGBPRPHENIITBEHWEDGQDAPGQTPNAQBPPA", "24993543664087146708838623554303770617208183782871143585577703905277130022547221607049877573165121536"));
    }
}
