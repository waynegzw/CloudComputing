...
public class AzureVMApiDemo {
    ...
    private static String storageAccountName = "zhangweiccproj";
    private static String resourceGroupNameWithVhd = "ccproj";
    ...
    private static String sourceVhdUri = String.format("https://%s.blob.core.windows.net/system/Microsoft.Compute/Images/vhds/%s", storageAccountName,
    ...
    public static String checkVM(ResourceContext context, String vmName) {
        ...
        try {
            ...
            DNSName = vmHelper.getName() + ".eastus.cloudapp.azure.com";
    ...
    public static String create() throws Exception{
        ...
        String dns = checkVM(context, vmName);
