...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("First", "http://ec2-52-90-237-93.compute-1.amazonaws.com");
		instances[1] = new DataCenterInstance("Second", "http://ec2-54-84-220-157.compute-1.amazonaws.com");
		instances[2] = new DataCenterInstance("Third", "http://ec2-52-91-143-57.compute-1.amazonaws.com");
	}
